...
python main_full_shot.py --finetune_entity --pretrain_ckpt $pretrain_ckpt  --pretrain_prompt_ckpt $pretrain_prompt_ckpt --max_epoch_entity 5
echo "end full-shot prompt-tune_entity"

# summary
echo "start full-shot prompt-tune_summary"
python main_full_shot.py --finetune_summary --pretrain_ckpt $pretrain_ckpt  --pretrain_prompt_ckpt $pretrain_prompt_ckpt --max_epoch_summary 5
