...
CUDA_VISIBLE_DEVICES=$device python --model PegasusMixPrompt main_full_shot.py --dataset_name $dataset --finetune_entity --pretrain_ckpt $pretrain_ckpt --pretrain_prompt_ckpt $pretrain_prompt_ckpt --cache_path /data/mathieu/hf_models/pegasus-large/
echo "end full-shot prompt-tune_entity"

# summary
echo "start full-shot prompt-tune_summary"
CUDA_VISIBLE_DEVICES=$device python --model PegasusMixPrompt main_full_shot.py --dataset_name $dataset --finetune_summary --pretrain_ckpt $pretrain_ckpt --pretrain_prompt_ckpt $pretrain_prompt_ckpt --cache_path /data/mathieu/hf_models/pegasus-large/
