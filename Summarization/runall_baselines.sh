...
#python main.py --dataset_name ccdv/cnn_dailymail --few_shot 10 --model T5Finetune --finetune_summary --lr_summary 5e-5 --use_pretrain_ckpt --infer_val_entities --use_entity_chain --use_t5_tagger --if_spacy --max_epoch_summary 60
#python main.py --dataset_name ccdv/cnn_dailymail --few_shot 10 --model T5Finetune --finetune_summary --use_pretrain_ckp --infer_val_entities --use_entity_chain --use_t5_tagger --if_spacy --full_testset --max_epoch_summary 0
...
#python main.py --dataset_name ccdv/cnn_dailymail --few_shot 100 --model T5Finetune --finetune_summary --lr_summary 5e-5 --use_pretrain_ckpt --infer_val_entities --use_entity_chain --use_t5_tagger --if_spacy --max_epoch_summary 60
python main.py --dataset_name ccdv/cnn_dailymail --few_shot 100 --model T5Finetune --finetune_summary --use_pretrain_ckpt --infer_val_entities --use_entity_chain --use_t5_tagger --if_spacy --full_testset --max_epoch_summary 0
