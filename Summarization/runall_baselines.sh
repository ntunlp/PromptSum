...
# # CUDA_VISIBLE_DEVICES=3 python main.py --few_shot 10 --model T5SoftPrompt --use_pretrain_ckpt --infer_val_entities --use_entity_chain --use_t5_tagger --if_spacy --finetune_summary --max_epoch_summary 0 --full_testset
# echo "end 10-shot baseline-2: simple prompt-tune summary"
...
# echo "evaluate 64-shot baseline-2: simple prompt-tune summary"
# # CUDA_VISIBLE_DEVICES=7 python main.py --few_shot 64 --model T5SoftPrompt --use_pretrain_ckpt --infer_val_entities --use_entity_chain --use_t5_tagger --if_spacy --finetune_summary --max_epoch_summary 0 --full_testset
# echo "end 64-shot baseline-2: simple prompt-tune summary"
...
# CNNDM
# echo "start 10-shot baseline-2: simple prompt-tune summary cnndm"
# CUDA_VISIBLE_DEVICES=1 python main.py --few_shot 10 --model T5SoftPrompt --use_pretrain_ckpt --infer_val_entities --use_entity_chain --use_t5_tagger --if_spacy --finetune_summary --dataset_name ccdv/cnn_dailymail
# echo "end 10-shot baseline-2: simple prompt-tune summary"

# echo "start 64-shot baseline-2: simple prompt-tune summary cnndm"
# CUDA_VISIBLE_DEVICES=1 python main.py --few_shot 64 --model T5SoftPrompt --use_pretrain_ckpt --infer_val_entities --use_entity_chain --use_t5_tagger --if_spacy --finetune_summary --dataset_name ccdv/cnn_dailymail
# echo "end 64-shot baseline-2: simple prompt-tune summary"

# echo "start 100-shot baseline-2: simple prompt-tune summary"
# CUDA_VISIBLE_DEVICES=2 python main.py --few_shot 100 --model T5SoftPrompt --use_pretrain_ckpt --infer_val_entities --use_entity_chain --use_t5_tagger --if_spacy --finetune_summary --dataset_name ccdv/cnn_dailymail
# echo "end 100-shot baseline-2: simple prompt-tune summary"


# echo "evaluate 10-shot baseline-2: simple prompt-tune summary"
# CUDA_VISIBLE_DEVICES=1 python main.py --few_shot 10 --model T5SoftPrompt --use_pretrain_ckpt --infer_val_entities --use_entity_chain --use_t5_tagger --if_spacy --finetune_summary --max_epoch_summary 0 --full_testset --dataset_name ccdv/cnn_dailymail
# echo "end 10-shot baseline-2: simple prompt-tune summary"


# echo "evaluate 64-shot baseline-2: simple prompt-tune summary"
# # CUDA_VISIBLE_DEVICES=2 python main.py --few_shot 64 --model T5SoftPrompt --use_pretrain_ckpt --infer_val_entities --use_entity_chain --use_t5_tagger --if_spacy --finetune_summary --max_epoch_summary 0 --full_testset --dataset_name ccdv/cnn_dailymail
# echo "end 64-shot baseline-2: simple prompt-tune summary"
