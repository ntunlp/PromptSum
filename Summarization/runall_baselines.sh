...
### k-shot
echo "start " + str(k_shot) + "-shot baseline-1: all-params finetune summary"
### train & val
...
echo "end " + str(k_shot) + "-shot baseline-1: all-params finetune summary"

echo "start " + str(k_shot) + "-shot baseline-2: simple prompt-tune summary"
### train & val
...
echo "end " + str(k_shot) + "-shot baseline-2: simple prompt-tune summary"

echo "start " + str(k_shot) + "-shot baseline-3: simple prompt-tune summary with pretrained ckpt"
### train & val
...
echo "end " + str(k_shot) + "-shot baseline-3: simple prompt-tune summary with pretrained ckpt"
