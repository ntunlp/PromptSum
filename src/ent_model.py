...
class T5EntFinetune(nn.Module):
    def __init__(self, args, model, tokenizer):
        super(T5EntFinetune, self).__init__()
        self.args = args
        self.model = model
        ### load ckpt
    ...
    def forward(self, batch):
        ...
        outputs = self._step(
            ...
            labels=lm_labels,
            decoder_attention_mask=batch['ents_mask']
        )
    ...
    def _generative_step(self, batch):
        ...
        generated_ids = self.model.generate(
            ...
            max_length=self.args.max_guidance_len,
            num_beams=4,
        ...
        target = self.ids_to_clean_text(batch["input_ents"])
